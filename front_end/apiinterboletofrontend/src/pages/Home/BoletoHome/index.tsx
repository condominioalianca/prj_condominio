...
import {requestBackend, requestBackendbyUser} from "../../../utils/requests";
...
const BoletoHome = () => {
    ...
    useEffect(() => {
        ...
        requestBackendbyUser(params).then((response) => {
            ...
            <div >
                <table className="table table-hover admin-container-table">
                    ...
                    {pageListBoletos?.content.map((boleto, key) => {
                        return (
                            <tr>
                                <td>{boleto.usuario.nomeUsuario}</td>
