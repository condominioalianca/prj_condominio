...
-- Atualiza as categorias existentes para Débito ('D') caso estejam sem tipo
UPDATE tb_categoria_gasto SET tipo = 'D' WHERE tipo IS NULL;

-- Carga de sugestão para categorias de Crédito ('C')
INSERT INTO tb_categoria_gasto (descricao, tipo, ativo) VALUES
('Taxa Condominial', 'C', true),
('Fundo de Reserva', 'C', true),
('Multas e Juros', 'C', true),
('Rendimento de Aplicação', 'C', true),
('Taxa de Mudança / Espaço', 'C', true),
('Outras Receitas', 'C', true);
